...
"[project]/src/config/locationConfig.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getCurrentConfig() {
    const location = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_LOCATION || 'location1';
    switch(location){
        case 'location1':
...
const TIME_SLOTS = config.timeSlots;
const DEFAULT_CAPACITY = config.defaultCapacity;
const LOCATION_NAME = config.locationName;
const SHORT_NAME = config.shortName;
const LOCATION_ADDRESS = config.locationAddress;
const CONTACT_EMAIL = config.contactEmail;
const FROM_EMAIL = config.fromEmail;
const BRANDING = config.branding;
const CHURCH_INFO = config.churchInfo;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/locationConfig.ts [app-client] (ecmascript)");
;
...
function AdminDashboard() {
    ...
    const [newTimeSlot, setNewTimeSlot] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [editingTimeSlot, setEditingTimeSlot] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [scheduledCloseDate, setScheduledCloseDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [scheduledCloseTime, setScheduledCloseTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [customClosureMessage, setCustomClosureMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            const initializeAndLoadData = {
                "AdminDashboard.useEffect.initializeAndLoadData": async ()=>{
                    try {
                        ...
                        if (existingSlots.length === 0) {
                            ...
                            try {
                                ...
                                const createPromises = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_SLOTS"].map({
                                    "AdminDashboard.useEffect.initializeAndLoadData.createPromises": async (slot, index)=>{
                                        console.log("⏰ Creating time slot ".concat(index + 1, ": ").concat(slot));
                                        const result = await client.models.TimeSlotConfig.create({
                                            timeSlot: slot,
                                            maxCapacity: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_CAPACITY"],
                                            currentRegistrations: 0,
                                            isActive: true
                                        });
                                        console.log("✅ Created time slot: ".concat(slot), result);
                                        return result;
                                    }
                                }["AdminDashboard.useEffect.initializeAndLoadData.createPromises"]);
                                ...
                                setTimeout({
                                    "AdminDashboard.useEffect.initializeAndLoadData": ()=>setMessage('')
                                }["AdminDashboard.useEffect.initializeAndLoadData"], 2000);
                            } catch (createError) {
            ...
            }["AdminDashboard.useEffect.initializeAndLoadData"];
    ...
    const loadData = async ()=>{
        try {
            ...
            let config = configData === null || configData === void 0 ? void 0 : configData[0];
            if (!config) {
            ...
            if (timeSlotErrors) {
                ...
                console.log('✅ Time slots loaded:', (timeSlotData === null || timeSlotData === void 0 ? void 0 : timeSlotData.length) || 0, timeSlotData);
            }
            // Load registrations
            ...
            if (registrationErrors) {
                ...
                console.log('✅ Registrations loaded:', (registrationData === null || registrationData === void 0 ? void 0 : registrationData.length) || 0);
                ...
                if (timeSlotData) {
                    const updatedTimeSlots = timeSlotData.map((slot)=>{
                        ...
                        console.log("📊 Time slot ".concat(slot.timeSlot, ": ").concat(actualCount, " actual registrations (was showing ").concat(slot.currentRegistrations, ")"));
                        return {
                            ...slot,
    ...
    const initializeTimeSlots = async ()=>{
        ...
        try {
            ...
            if (existingSlots.length === 0) {
                ...
                const promises = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_SLOTS"].map((slot)=>client.models.TimeSlotConfig.create({
                        timeSlot: slot,
                        maxCapacity: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_CAPACITY"],
                        currentRegistrations: 0,
                        isActive: true
    ...
    const updateTimeSlotCapacity = async (id, newCapacity)=>{
        ...
        try {
            ...
            setMessage("✅ Time slot capacity updated to ".concat(newCapacity, " people!"));
    ...
    const addNewTimeSlot = async ()=>{
        ...
        try {
            ...
            setMessage('✅ New time slot "'.concat(newTimeSlot, '" added successfully!'));
            setNewTimeSlot('');
            loadData();
        } catch (error) {
    ...
    const updateTimeSlotTime = async (id, newTime)=>{
        ...
        try {
            ...
            setMessage('✅ Time slot updated to "'.concat(newTime, '"!'));
    ...
    const deleteTimeSlot = async (id, timeSlot)=>{
        if (!confirm("Are you sure you want to delete the ".concat(timeSlot, " time slot? This will also delete any registrations for this time slot."))) {
            return;
        }
        try {
            setLoading(true);
            ...
            setMessage('✅ Time slot "'.concat(timeSlot, '" deleted successfully!'));
            loadData();
        } catch (error) {
    ...
    const cleanupDuplicateTimeSlots = async ()=>{
        try {
            ...
            allSlots === null || allSlots === void 0 ? void 0 : allSlots.forEach((slot)=>{
            ...
            for (const [timeSlot, slots] of Object.entries(timeSlotGroups)){
                if (slots.length > 1) {
                    ...
                    for(let i = 1; i < slots.length; i++){
                        ...
                        deletedCount++;
                        console.log("🗑️ Deleted duplicate time slot: ".concat(timeSlot, " (").concat(slots[i].id, ")"));
                    }
                }
            }
            setMessage("✅ Cleaned up ".concat(deletedCount, " duplicate time slots!"));
    ...
    const generateInviteLink = async ()=>{
        ...
        try {
            ...
            const inviteUrl = "".concat(window.location.origin, "/register/").concat(token);
            navigator.clipboard.writeText(inviteUrl);
            setMessage("Invite link generated and copied to clipboard: ".concat(inviteUrl));
            setInviteEmail('');
        } catch (error) {
    ...
    const updateRegistrationStatus = async (field, value)=>{
        ...
        try {
            ...
            setMessage("✅ Registration ".concat(field.replace(/([A-Z])/g, ' $1').toLowerCase(), " updated!"));
    ...
    const toggleRegistrationOpen = ()=>{
        updateRegistrationStatus('isRegistrationOpen', !(registrationConfig === null || registrationConfig === void 0 ? void 0 : registrationConfig.isRegistrationOpen));
    };
    const toggleInviteOnlyMode = ()=>{
        updateRegistrationStatus('inviteOnlyMode', !(registrationConfig === null || registrationConfig === void 0 ? void 0 : registrationConfig.inviteOnlyMode));
    };
    const scheduleRegistrationClosure = async ()=>{
        if (!registrationConfig || !scheduledCloseDate) return;
        const scheduledDateTime = scheduledCloseTime ? "".concat(scheduledCloseDate, "T").concat(scheduledCloseTime, ":00.000Z") : "".concat(scheduledCloseDate, "T23:59:59.000Z");
        try {
            setLoading(true);
            const updatedConfig = await client.models.RegistrationConfig.update({
                id: registrationConfig.id,
    ...
    const sendConfirmationEmails = async ()=>{
        try {
            ...
            setMessage("📧 Sending confirmation emails to ".concat(activeRegistrations.length, " registrations..."));
            // Note: In a real implementation, you would call the Lambda function here
            // For now, we'll simulate the process
            setTimeout(()=>{
                setMessage("✅ Sent confirmation emails to ".concat(activeRegistrations.length, " registrations! Check the email inboxes."));
    ...
    const exportRegistrations = ()=>{
        const csvContent = [
            ...
            ...registrations.map((reg)=>[
                    "".concat(reg.firstName, " ").concat(reg.lastName),
                    reg.email,
                    reg.phone,
                    reg.timeSlot,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                style: {
                    background: "linear-gradient(135deg, ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BRANDING"].primaryColor, ", ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BRANDING"].secondaryColor, ")")
                },
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BRANDING"].locationEmoji
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$locationConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCATION_NAME"]
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/page.tsx",
                                        lineNumber: 682,
                                        columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    registrationConfig && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "px-3 py-2 rounded-lg font-semibold text-center ".concat(registrationConfig.isRegistrationOpen ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                disabled: loading,
                                                className: "w-full px-4 py-2 rounded-lg font-semibold transition-all ".concat(registrationConfig.isRegistrationOpen ? 'bg-red-600 hover:bg-red-700 text-white' : 'bg-green-600 hover:bg-green-700 text-white', " disabled:opacity-50"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "px-3 py-2 rounded-lg font-semibold text-center ".concat(registrationConfig.inviteOnlyMode ? 'bg-orange-100 text-orange-800' : 'bg-blue-100 text-blue-800'),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                disabled: loading,
                                                className: "w-full px-4 py-2 rounded-lg font-semibold transition-all ".concat(registrationConfig.inviteOnlyMode ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-orange-600 hover:bg-orange-700 text-white', " disabled:opacity-50"),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    registrationConfig.scheduledCloseDate && registrationConfig.autoCloseEnabled && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            (registrationConfig === null || registrationConfig === void 0 ? void 0 : registrationConfig.autoCloseEnabled) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    timeSlots.length > 6 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    timeSlots.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex-1",
                                                        children: [
                                                            editingTimeSlot === slot.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "".concat(statusColor, " h-2 rounded-full transition-all"),
                                                                    style: {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: filteredRegistrations.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 1126,
                            columnNumber: 13
                        }, this) : filteredRegistrations.map((reg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-white border-2 border-purple-200 rounded-lg p-4 hover:shadow-lg transition-all",
                                children: editingRegistration === reg.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "text",
                                                    value: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.firstName) || '',
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "text",
                                                    value: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.lastName) || '',
                                                    onChange: (e)=>setEditFormData((prev)=>prev ? {
                                                                ...prev,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "email",
                                                    value: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.email) || '',
                                                    onChange: (e)=>setEditFormData((prev)=>prev ? {
                                                                ...prev,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "tel",
                                                    value: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.phone) || '',
                                                    onChange: (e)=>setEditFormData((prev)=>prev ? {
                                                                ...prev,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    value: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.timeSlot) || '',
                                                    onChange: (e)=>setEditFormData((prev)=>prev ? {
                                                                ...prev,
                                                    ...
                                                    children: [
                                                        ...
                                                        '11:00',
                                                        '11:30'
                                                    ].map((slot)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: slot,
                                                            children: slot
                                                        }, slot, false, {
                                                            fileName: "[project]/src/app/admin/page.tsx",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "number",
                                                    value: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.numberOfKids) || 0,
                                                    onChange: (e)=>setEditFormData((prev)=>prev ? {
                                                                ...prev,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                        type: "checkbox",
                                                        checked: (editFormData === null || editFormData === void 0 ? void 0 : editFormData.needsChildcare) || false,
                                                        onChange: (e)=>setEditFormData((prev)=>prev ? {
                                                                    ...prev,
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "px-2 py-1 rounded font-bold ml-1 ".concat(reg.needsChildcare ? 'bg-green-200 text-green-800' : 'bg-gray-200 text-gray-800'),
                                                            ...
                                                            reg.referredBy && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "text-purple-700",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "font-bold",
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    reg.isCancelled ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        ...
                                                                        lineNumber: 1225,
                                                                        columnNumber: 31
                                                                    }, this) : reg.attendanceConfirmed ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        ...
                                                                        lineNumber: 1227,
                                                                        columnNumber: 31
                                                                    }, this) : reg.confirmationToken ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(AdminDashboard, "K/AUfHZaiJnhwt2HKbWc0THcY8Y=");
_c = AdminDashboard;
const formFields = {
    signIn: {
        username: {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: [
                                                                    "Welcome, ",
                                                                    user === null || user === void 0 ? void 0 : (_user_signInDetails = user.signInDetails) === null || _user_signInDetails === void 0 ? void 0 : _user_signInDetails.loginId
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/admin/page.tsx",
                                                                lineNumber: 1325,
...
//# sourceMappingURL=_602e76d2._.js.map